...
import com.green.madang2.manager.customer.model.CustomerGetReq;
import com.green.madang2.manager.customer.model.CustomerGetRes;
import com.green.madang2.manager.customer.model.CustomerPostReq;
import com.green.madang2.manager.customer.model.CustomerPutReq;
...
public class CustomerController {
    ...
    //@ParameterObject - Swagger용 애노테이션, RequestParam으로 설정햇을 때 나오는 FORM처럼 되게 한다.
    ...
    public MyResponse<Integer> putCustomer(@RequestBody CustomerPutReq p) {
        return new MyResponse<>(p.getCustId() + "번 고객을 수정하였습니다.", service.putCustomer(p));
    }
